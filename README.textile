...
This will leave a fully-compiled Clutch jar file in the 'target' directory. You can also run the Clutch tests by executing the following in your command line after installing:
