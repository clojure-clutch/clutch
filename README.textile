...
For installation and help on Leiningen visit the "github repo":http://github.com/technomancy/leiningen/ .
...
If you are working with a clone of Clutch from github for development or testing purposes, in your command line execute:

<pre>lein install</pre>

This will leave a fully-compiled Clutch jar file in the 'current' directory. You can also run the Clutch tests by executing the following in your command line:
