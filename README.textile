...
;; optionally configure using dynamic scope w/ with-db 
...
h4. View server configuration & view API usage
...
=> (-> (get-view "clutch_example" "demo_views" :sum) :rows first :value)
60
=> (get-view "clutch_example" "demo_views" :sum {:reduce false})
{:total_rows 3, :offset 0, :rows [{:id "0896fbf57128d7f1a1b238a52b0ec372", :key nil, :value 20}
